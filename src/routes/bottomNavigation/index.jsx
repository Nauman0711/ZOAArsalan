...
const Tabs = () => {
    return (
        <Tab.Navigator>
            ...
            <Tab.Screen options={{ tabBarIcon: ({ focused }) => <FontAwesome size={24} name="bell" color={focused ? colors.green : colors.fontBlack} />, tabBarActiveTintColor: colors.green, tabBarInactiveTintColor: colors.fontBlack}} name="Notifications" component={Notifications} />
        </Tab.Navigator>
    );
}
export default Tabs